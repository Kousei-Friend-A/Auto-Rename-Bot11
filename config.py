...
class Config(object):
    # pyro client config
    API_ID    = os.environ.get("API_ID", "12321125")
    API_HASH  = os.environ.get("API_HASH", "6a34b69aa63177ec36f8d9b24c296f40")
    BOT_TOKEN = os.environ.get("BOT_TOKEN", "7245327451:AAHN6gddJa1dyiR-H0O5hLOTDktpRXSOuN4") 

    # database config
    DB_NAME = os.environ.get("DB_NAME","AshutoshGoswami24")     
    DB_URL  = os.environ.get("DB_URL","mongodb+srv://manu:manu1234@cluster0.1trpq.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
 
    # other configs
    BOT_UPTIME  = time.time()
    START_PIC   = os.environ.get("START_PIC", "")
    ADMIN       = [int(admin) if id_pattern.search(admin) else admin for admin in os.environ.get('ADMIN', '6649521395').split()]
    # -- FORCE_SUB_CHANNELS = ["BotzPW","AshuSupport","AshutoshGoswami24"] -- # 
    FORCE_SUB_CHANNELS = os.environ.get('FORCE_SUB_CHANNELS', 'AshutoshGoswami24,BotzPW').split(',')
    LOG_CHANNEL = int(os.environ.get("LOG_CHANNEL", "-1002196452502"))
